...
**ANDROID - TERMUX**
```bash
wget https://github.com/adfastltda/scanv4/releases/download/scanv4/scanv4_for_arm64_x86_x86_64.zip && unzip scanv4_arm64_android.zip && chmod +x scanv4 && ./scanv4 -h
```
